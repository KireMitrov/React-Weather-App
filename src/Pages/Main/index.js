...
function Main() {
    ...
    return (
        ...
        <div style={background} className="main-container">
            ...
            <div className="current-weather">
                <div className="temperature">{data.main && Math.round(data.main.temp)} &deg;C</div>
                ...
                <div className="hi-low">Hi: {data.main && Math.round(data.main.temp_min)} &deg;C Low: {data.main && Math.round(data.main.temp_max)} &deg;C</div>
